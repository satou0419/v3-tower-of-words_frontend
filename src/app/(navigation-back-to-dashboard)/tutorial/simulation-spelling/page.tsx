...
const tutorialData: TutorialData[] = [
    ...
    {
        imagePath:
            "assets/images/tutorial/simulation_spelling/simulation_spelling_5.png",
        title: "Fifth Tutorial",
        description: "Click the audio button to hear the word.",
    },
    {
        imagePath:
            "assets/images/tutorial/simulation_spelling/simulation_spelling_6.png",
    ...
    {
        imagePath:
            "assets/images/tutorial/simulation_spelling/simulation_spelling_7.png",
        title: "Seventh Tutorial",
        description: "Click the ‘Go!’ button after spelling the word.",
    },
]

export default function SimulationSpelling() {
    ...
    const callbackRef = useRef(() => {
        updateTutorialStatus("spellingsimu")
    })
